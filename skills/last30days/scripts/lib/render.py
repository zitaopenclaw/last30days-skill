...
_FOOTER_SOURCES: list[tuple[str, str, str, str, list[tuple[str, str]]]] = [
    ...
    ("bilibili", "📺", "Bilibili", "video", [("views", "views"), ("likes", "likes")]),
    ("v2ex", "🟢", "V2EX", "topic", [("replies", "replies")]),
    ("juejin", "📘", "掘金", "article", [("likes", "likes"), ("comments", "comments")]),
    ("xiaohongshu", "🌹", "Xiaohongshu", "post", [("likes", "likes"), ("comments", "comments"), ("collects", "collects")]),
